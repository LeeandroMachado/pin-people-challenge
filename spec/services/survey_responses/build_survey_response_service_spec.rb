...
RSpec.describe SurveyResponses::BuildSurveyResponseService, type: :service do
  ...
  describe "#call" do
    context "with valid parameters" do
      it "creates a new SurveyResponse instance" do
        result = service.call(row, caches, employee)

        expect(result.class).to eq(SurveyResponse)
      end
    end
  end
end
